...
I am using the `tidyverse` in R to handle the data processing and visualization.
...
It seems that the datasets from 2019 and 2020 have different column names (e.g., `trip_id` vs `ride_id`).
